...
namespace MVC.Controllers
{
    public class RegistrationsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "RegistrationID,CourseID,StudentID,EnrollmentDate")] Registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "RegistrationID,CourseID,StudentID,EnrollmentDate")] Registration registration)
        {
            if (ModelState.IsValid)
            {
